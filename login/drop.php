...
<div class="jumbotron container mt-5">
  <img class=" float-end image-fluid" src="images/h.png" alt="this is a image" srcset="" style="max-width: 90%;">
  
  <br><br>
  <h1 class="display-4"><b>Dear <?php echo "Welcome ". $_SESSION['username']?></b></h1>
  ...
  <h1>"Booking <span class="text-muted "> Confirmed..."</span></h1>
 <br><br><br><br><br>
 <br>
</div>
